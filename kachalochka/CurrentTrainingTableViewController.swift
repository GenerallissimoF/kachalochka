...
class CurrentTrainingTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "currentCell")
 ...
 //   }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print(workout?.chest[indexPath.row].rawValue)
        content.text = trainingg?.rawValue
